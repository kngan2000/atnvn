        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <button><a href="?page=Update_product&&id=<?php echo $row["productid"]; ?>">Edit</a></button>
                        <button><a href="?page=product_management&&function=del&&id=<?php echo $row["productid"]; ?>" onClick="return confirm ('Are you sure delete')">Delete</a></button>
                    </td>
                </tr>
            <?php $id++;
            } ?>
